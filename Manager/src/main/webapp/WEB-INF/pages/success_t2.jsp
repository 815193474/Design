...
<!--startprint-->
<div id="form1">
<p id="title">党支部派人谈话记录表二</p>
<table id="table_b" >
<tr><td>入党申请人姓名</td><td>${talk.name }</td><td>单位及职务</td><td colspan="3">${talk.className.className }</td></tr>
<tr><td>谈话人姓名</td><td>${talk.talk_teacher_2 }</td><td>单位及职务</td><td colspan="3"></td></tr>
...
<!--endprint--> 
<a onclick="showAtRight('../list/talk?id=${talk.id } ')" href="###" id="load" >查看表一</a>

</div>
<div id="box_r">
<input type="button" onclick="doPrint()" value="打印" id="load"/>
<a href="../export/talk_details?id=${talk_id }" id="load">下载表一Word文件</a>
<a href="../export/talk_details?id=${talk_id }" id="load">下载表二Word文件</a>
