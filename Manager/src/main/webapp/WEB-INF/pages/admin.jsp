...
<body>
	 <div class="navbar navbar-fixed-top navbar-inverse" style="background-color: #d9edf7;border: none;">  
      <div class="container-fluid">  
        <div class="nav-logo">
          <a href="#" ><i class="iconfont icon-icon_zhanghao" title="管理员">&nbsp;&nbsp;</i><i>${admin.name }</i>&nbsp;&nbsp;</a>
        </div>
        ...
        <div class="collapse navbar-collapse " id="navBar" >  
          ...
          <ul class="nav navbar-nav navbar-right">
       		...
       		<li tyle="margin-right: 50px;" ><a href="javascript:alert('需要产品定制请联系微信a815193474')"  ><i  class="iconfont icon-dingzhi" >&nbsp;&nbsp;</i>产品定制
                    ...
                    <li style="margin-right: 50px;"><a href="../login/loginout" ><i  class="iconfont icon-poweroff" title="注销登录"></i>&nbsp;&nbsp;注销
                    </a></li>
          </ul>  
        </div>
      </div>
	 	...
	 	<li id="select_1" class="list-group-item" style="display:none;"> 
	       <ul class="list-group" >  
		       <li class="list-group-item">
		       	<a href="###" onclick="showAtRight('../list/base_teacher?next=0');"><i  class="iconfont icon-team" >&nbsp;</i>联系人分配管理</a>
		       </li>
		       <li class="list-group-item">
		       	<a href="###" onclick="showAtRight('../list/base_admin?next=0');"><i  class="iconfont icon-team" >&nbsp;</i>积极分子管理</a>

		       </li>
			   <li class="list-group-item"><a href="###" onclick="showAtRight('../list/recommend_admin?next=0');"> <i  class="iconfont icon-team" >&nbsp;</i>发展党员管理</a></li>
		       <li class="list-group-item">
		       	<a href="###" onclick="showAtRight('../list/league?next=0')" ><i  class="iconfont icon-team" >&nbsp;</i>团支书管理 </a>
		       </li>  
		       <li class="list-group-item">
		       	<a href="###" onclick="showAtRight('../list/class?next=0')" ><i  class="iconfont icon-banjiguanli" >&nbsp;</i>班级管理</a>
		       </li>  
		  </ul>
		  </li> 
		  <li id="left_li_2" id="menu_1" class="list-group-item" onclick="show_1()"><i  class="iconfont icon-plus-square" >&nbsp;&nbsp;</i><i id="menu_1">数据添加</i> </li>
			<li id="select_2" style="display:none;" class="list-group-item" >
				<ul class="list-group">
			       <li class="list-group-item"><a href="###" onclick="showAtRight('../insert/teacher?next=0')" ><i  class="iconfont icon-addteam" >&nbsp;</i>添加培养联系人</a></li>  
			     
			       <li class="list-group-item"><a href="###" onclick="showAtRight('../insert/league');"><i  class="iconfont icon-addteam" >&nbsp;</i>添加团支书</a></li>  
			       <li class="list-group-item"><a href="###" onclick="showAtRight('../insert/class')" ><i  class="iconfont icon-tianjiabanji" >&nbsp;</i>添加班级</a></li>  
				</ul>
			</li>
