      ...
      <div class=" col-sm-11 ">
        <div class="col-sm-3 ">
          <div class="input-group">
            <input type="text"  class="form-control" id="select_recommend_re" placeholder="请输入姓名查找">
          <span class="input-group-addon"><a href="###" onclick="sue()"><i  class="iconfont icon-sousuo white pull-right" ></i></a></span> 
          </div>
        ...
        <div class="col-sm-3 col-sm-offset-1 ">
          ...
          <select id="select_class_re_1" class="form-control" name="className">
          <option>按班级查找</option>
          <c:forEach items="${className}" var="c" varStatus="status">
          <option value="${c.id}">${c.className }</option>
          </c:forEach>
          </select>
          <span class="input-group-addon"><a href="###" onclick="suk()"><i  class=" iconfont icon-sousuo white" ></i></a></span>
          </div>
        </div>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="col-sm-6 col-sm-offset-4">
          <br>
        <ul class="pagination">
          <li> <a  id="load_1" href="###" onclick="showAtRight('../list/select_recommend?next=${next_p}&name=${name}')" type="text/html">&laquo;</a> </li>
          <li> <a id="load_2" href="###" onclick="showAtRight('../list/select_recommend?next=0&name=${name}')" type="text/html">首页</a></li>
          <li> <a id="load_1" href="###" >共${num_p }页</a></li>
          <li> <a id="load_1" href="###" >共${num_b }条</a></li>
          <li> <a id="load_1" href="###" onclick="showAtRight('../list/select_recommend?next=${next_n}&name=${name}')" type="text/html">&raquo;</a></li>
        </ul>
        </div>
      </div>
    </div>
